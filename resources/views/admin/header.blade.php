                        ...
                        <ul class="navbar-nav mr-auto">
							...
							<li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{ route('manage-reasons.index') }}">Manage Close Account Reasons</a>
                                </div>
                            </li>
                            @endcan
							<li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{ route('manage-app-comments') }}">Manage Comments</a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('manage-close-account-request.request') }}">Close Request</a>
                            </li>
                            @endif
                            @if(Auth::user()->role!='admin')
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('manage-delete-account-request') }}">Delete Account Request</a>
                            </li>
                            @endif
                            @can('is-admin')
							<li class="nav-item dropdown">
							...
							<li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{ route('manage-content.index') }}">Manage Contact Us Content</a>
                                </div>
                            </li>
                            @endcan
                            @can('is-admin')
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{ route('manage-close-account-request.index') }}">Manage Close Account Requests</a>
                                    <a class="dropdown-item" href="{{ route('manage-help-request.index') }}">Manage Help Requests</a>
                                    <a class="dropdown-item" href="{{ route('custom-notification.index') }}">Manage Notifications</a>
                                </div>
                            </li>
                            @endcan
                            @can('is-admin')
